...
<head>
    ...
    <style>
        ...
        .auth-container {
            max-width: 450px;
            background-color: #2a2a2a; /* Pulled from style.css but defined here for clarity if needed */
            color: #f0f0f0;
            border-radius: 10px;
...
<body class="bg-dark text-light">
    ...
    <main class="container d-flex justify-content-center align-items-center my-5">
        <section class="auth-container p-4 rounded shadow-lg">
            ...
            <?php
            // Display flash messages after a failed login attempt
            if ($flash = $session->getFlash('login_error')) {
            ...
            <p class="mt-3 text-center">Don't have an account? <a href="register" class="text-info text-decoration-none">Register here</a></p>
        </section>
    </main>
